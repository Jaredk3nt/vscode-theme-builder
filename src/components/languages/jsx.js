  ...
  return (
    <pre>
      <code className="jsx">
        ...
        <span
          className={`${SOURCE_MAP.SOURCE_JS} ${SOURCE_MAP.META_CLS_BODY_JS} ${SOURCE_MAP.META_FUNC_METH_JS} ${SOURCE_MAP.META_TAG_JSX} ${SOURCE_MAP.JSXATTR} ${SOURCE_MAP.JSXNESTED} ${SOURCE_MAP.META_TAG_JSX} ${SOURCE_MAP.JSXATTR} ${SOURCE_MAP.KEY_OP_ASSIGN_JS}x`}
        >
          =
        </span>
        <span
